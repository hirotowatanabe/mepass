        ...
        <main class="admin-main">
            <div class="admin-main_top">
                <form action="index.php" method="post">
                    <input class="admin-main_top_search" type="text" name="userSearch" value="<?php print $searchValue; ?>" placeholder="店舗名検索" />
                    <input class="admin-main_top_submit" type="submit" name="btn" value="検索" />
                </form>
                <a class="anchor_btn" href="/company/store/create/">新規店舗登録</a>
            </div>
            <?php if($NumRow != 0): ?>
            <table>
                <tr>
